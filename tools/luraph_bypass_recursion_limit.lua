-- Luraph Anti-Tamper Bypass - RECURSION LIMIT VERSION
-- Based on TechHog8984's full bypass but adds recursion depth tracking
-- Prevents stack overflow by limiting recursive calls

print("[BYPASS] Loading recursion-limited Luraph anti-tamper bypass...")
...
local MAX_RECURSION = 50  -- Prevent infinite recursion
...
-- Hook debug.info with recursion limit
...
print("[OK] Recursion-limited bypass installed")
print("[OK] pcall, setfenv, debug.info, debug.traceback all hooked")
print(string.format("[INFO] Recursion limit set to %d calls", MAX_RECURSION))
...
print("=== Recursion-Limited Bypass Ready ===")
